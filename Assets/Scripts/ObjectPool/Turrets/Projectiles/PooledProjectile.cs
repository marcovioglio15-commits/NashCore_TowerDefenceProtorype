...
namespace Scriptables.Turrets
{
    ...
    public class PooledProjectile : MonoBehaviour, IPoolable<PooledProjectile, ProjectileSpawnContext>
    {
        ...
        private ProjectileDefinition defaultClass;
        ...
        {
            ProjectileSpawnContext context = new ProjectileSpawnContext(defaultClass, transform.position, transform.forward, 1f, transform.parent);
        ...
        public void ResetPoolable()
        {
            ...
            remainingPierces = 0;
            lastContext = new ProjectileSpawnContext(defaultClass, Vector3.zero, Vector3.forward, 1f, null);
